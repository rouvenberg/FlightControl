...
TrimPoint.States.debar = -0.10422;
TrimPoint.States.dabar = -1.8464e-16;
TrimPoint.States.drbar = -2.00e-16;
TrimPoint.States.dtbar = 0.36226;

TrimPoint.States.X_P = 6167.1072;

TrimPoint.States.Phibar   = 0;
TrimPoint.States.Thetabar = 0.068324;
TrimPoint.States.Psibar   = 1.0472;

TrimPoint.States.Latbar   = 0.93527;
TrimPoint.States.Lonbar   = 0.17276;
TrimPoint.States.Altbar   = 4004.9841;

TrimPoint.States.ubar = 129.5153;
TrimPoint.States.vbar = -2.6818e-16;
TrimPoint.States.wbar = 8.8628;  
...
% Inertia tensor:
Ixx = 102630;                                                               % inertia around body-fixed x axis in "kg*m^2"
Iyy = 274335;                                                               % inertia around body-fixed y axis in "kg*m^2"
Izz = 362250;                                                               % inertia around body-fixed z axis in "kg*m^2"
Ixz = 14996;                                                                % product of inertia in "kg*m^2"
    
% Mass:
CNT_g = [0;0;9.81];                                                         % Gravitational acceleration vector 
CNT_m = 15975;                                                              % aircraft mass in "kg"

%% Propulsion:

% Engine dynamics
Propulsion.Act_t = ss(-0.5132, 0.5132, 1, 0);   
...
k = 1.13;                                                                   % temporary scaling factor
...
% elevator dynamics
Actuators.Act_e = ss(-21.7671, 21.7671, 1, 0);                              % elevator dynamics
...
Actuators.Delays.tau_de = 0.052;                                            % time delay of elevator in "s"
...
% aileron dynamics
Actuators.Act_a = ss(-36.4223, 36.4223, 1, 0);  
...
Actuators.Delays.tau_da = 0.04;                                             % time delay of aileron in "s"
...
% rudder dynamics
Actuators.Act_r = ss(-16.0029,  16.0029,  1, 0); 
...
Actuators.Delays.tau_dr = 0.04;                                             % time delay of aileron in "s"
...
% lift parameters
Aerodynamics.Ca_L0 = 0.065;  
Aerodynamics.Ca_La = 4.86;
Aerodynamics.Ca_Lq = 7.8; 
Aerodynamics.Ca_Lde = 0.35;

% drag parameters
Aerodynamics.Ca_D0 = 0.014; 
Aerodynamics.Ca_Da = 0.2;
Aerodynamics.Ca_Da2 = 0.69;
Aerodynamics.Ca_Db2 = 0.046; 

% side force coefficient
Aerodynamics.Ca_Yb = -0.9;  
Aerodynamics.Ca_Ydr = 0.13;
Aerodynamics.Ca_Yp = 0;
Aerodynamics.Ca_Yr = 0.0119;

% roll moment coefficient
Aerodynamics.Ca_lb = -0.39; 
Aerodynamics.Ca_lp = -10.9; 
Aerodynamics.Ca_lr = 4.532;
Aerodynamics.Ca_lda = -0.44;
Aerodynamics.Ca_ldr = 0.05;

% pitch moment coefficient
Aerodynamics.Ca_m0 = -0.14; 
Aerodynamics.Ca_ma = -1.23;
Aerodynamics.Ca_mq = -9.5;
Aerodynamics.Ca_mde = -2.2;

% yaw moment coefficient
Aerodynamics.Ca_nb = 0.85;  
Aerodynamics.Ca_np = 0.34; 
Aerodynamics.Ca_nr = -7.5;
Aerodynamics.Ca_nda = 0.022;
